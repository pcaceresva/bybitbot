...
def execute_trade(symbol: str, side: str):
    """
    Ejecuta una orden de mercado usando saldo de demo y configuración definida
    """
    # Obtenemos precio de mercado real
    ticker = session.get_symbol_price_ticker(symbol=symbol)
